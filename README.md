# Infrastructure and Deployment repository structure

Contents

1. [Provisioning infrastructure](README.md#provisioning-infrastructure)
2. [Deployment of products](README.md#deploying-products)
3. [Running scenario tests](README.md#running-scenario-tests)

Testgrid test-run workflow can be summarized into following three steps:

1. Provision infrastructure (infra-provision.sh)
2. Deploy product deployment pattern (deploy.sh)
3. Run scenario tests against the deployment (run-scenarios.sh)
